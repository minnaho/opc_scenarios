...
ax.bar(np.arange(len(title_exp))[indices],avgp[indices],yerr=stdp[indices],color='white',edgecolor='k',capsize=4)
ax.bar(range(len(title_exp))[1:-2:2],avgp[1:-2:2],yerr=stdp[1:-2:2],color='gray',capsize=4)
...
savename = var_name+'_avg_4years_yearly_diff'+region_name+'_springsummer.png'
