...
for t_i in range(len(ncfiles)):
    ...
    if 'PNDN' in ncfiles[t_i]:
        p_plot1 = ax.pcolormesh(lon_nc,lat_nc,varplt,transform=ccrs.PlateCarree(),cmap=c_map1,vmin=0,vmax=0.0023)
    else:
...
savename = 'map_100m_int_'+varstr+'_'+region_name+'_'+exp[-1]+'_pndn_only_abs_fullts.png'
