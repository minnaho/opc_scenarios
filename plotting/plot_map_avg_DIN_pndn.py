...
if perc == True:
    ...
    if avg == True:
        savename = 'map_avg_'+str(dp_avg0*2)+'_'+str(dp_avg1*2)+'_'+varstr+'_'+timename+'_'+region_name+'_'+exp[-1]+'_pndn_perc.png'
elif avg == True:
    savename = 'map_avg_'+str(dp_avg0*2)+'_'+str(dp_avg1*2)+'_'+varstr+'_'+timename+'_'+region_name+'_'+exp[-1]+'_pndn_abs.png'
    if mmol == False:
        savename = 'map_avg_'+str(dp_avg0*2)+'_'+str(dp_avg1*2)+'_'+varstr+'_'+timename+'_'+region_name+'_'+exp[-1]+'_pndn_mgL_abs.png'
else:
    savename = 'map_'+str(depth)+'m_'+varstr+'_'+timename+'_'+region_name+'_'+exp[-1]+'_pndn_abs.png'
