...
cntrl_var = np.squeeze(Dataset(outpath+'avg_fullts_int_avg_100m_50m_cntrl'+fileen,'r').variables[var_nc])*mask_mult
...
savename = var_name+'_'+year_month+'_'+region_name+'_'+exp[-1]+'_bar_norm_compold.png'
