...
linec = 'cornflowerblue'

figw = 7
figh = 12

fig,ax = plt.subplots(len(exp),1,figsize=[figw,figh])
ax.plot(plt_prof[0],depplt,color=linec)
ax.plot(plt_prof_05[0],depplt,color=linec,linestyle='--')
ax.plot(plt_prof_95[0],depplt,color=linec,linestyle='--')
...
savename = 'prof_dif_'+var+'_'+region_name+'_'+exp[-1]+'.png'
