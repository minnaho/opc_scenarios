...
savename = 'pdf_'+varname+'_'+region_name+'_fixriver'
...
# read variables
l1617_nc = Dataset(roms_path+'concat_int_100m_fulll_2012_2017_biomass.nc','r')
cntrl_nc = Dataset(roms_path+'concat_int_100m_cntrl_initap_realistic_biomass.nc','r')
fulll_nc = Dataset(roms_path+'concat_int_100m_fndn90_fixriver_biomass.nc','r')
exp01_nc = Dataset(roms_path+'concat_int_100m_PNDN_only_realistic_biomass.nc','r')
exp02_nc = Dataset(roms_path+'concat_int_100m_FNDN_only_realistic_biomass.nc','r')
exp03_nc = Dataset(roms_path+'concat_int_100m_pndn50_fixriver_biomass.nc','r')
exp04_nc = Dataset(roms_path+'concat_int_100m_pndn90_fixriver_biomass.nc','r')
exp05_nc = Dataset(roms_path+'concat_int_100m_fndn50_fixriver_biomass.nc','r')
