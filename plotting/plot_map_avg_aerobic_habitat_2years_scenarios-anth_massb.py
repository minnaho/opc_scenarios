...
# read data
###########################
massbpath = 'aerobichabitat_nutrientmngmt.mat'

matr = scipy.io.loadmat('aerobichabitat_nutrientmngmt.mat')
# keys 
...
# plot histogram of area of aerobic habitat change
nbins = 100
...
axhist.legend(loc='best',fontsize=axfont)
axhist.tick_params(axis='both',which='major',labelsize=axfont)
fighist.savefig(savepath+'hist_aerobic_habitat_fndn.png',bbox_inches='tight')
