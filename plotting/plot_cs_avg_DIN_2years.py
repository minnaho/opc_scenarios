...
exp = ['cntrl_initap_realistic','','PNDN_only','pndn50']
...
for n_i in range(len(exp)):
    ...
    ax.flat[n_i].ticklabel_format(useOffset=False,style='plain')
...
ax.flat[n_i-1].set_xlabel('Longitude',fontsize=axis_tick_size)
...
fig.suptitle('Average '+var_name+' '+loc,fontsize=axis_tick_size)
