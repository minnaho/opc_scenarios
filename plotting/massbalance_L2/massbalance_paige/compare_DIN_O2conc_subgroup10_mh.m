...
dir_gr = '/data/project3/minnaho/opc_scenarios/plotting/massbalance_L2/figs';
s2d = 86400 ;
...
if new==1
%% NEW PERIOD
rep_out = '/data/project3/minnaho/opc_scenarios/plotting/massbalance_L2/';
fout =  [rep_out,opcsc,'/','budget_L2_mask10_',vname,'_',num2str(depthmin),'_to_',num2str(depthmax),'_',opcsc,'.nc'];
fout0 =  [rep_out,'cntrl/','budget_L2_mask10_',vname,'_',num2str(depthmin),'_to_',num2str(depthmax),'_cntrl.nc'];
...
ts1 = bgc(4:end-1,:,1)-bgc0(:,:,1) ; % CHANGE IN BIO NO3
ts2 = bgc(4:end-1,:,2)-bgc0(:,:,2) ; % CHANGE IN BIO NH4
