...
avg2year = np.nanmean(clim_res1[1:],axis=1)
...
for e_p in range(len(title_exp1)):
    ...
    pplot = ax.pcolormesh(lonnc,latnc,avg2year[e_p],transform=ccrs.PlateCarree(),cmap=c_map,vmin=v_min,vmax=v_max)
    ...
    savename = 'map_2years_minuscntrl_massb_diff_'+varn+dep+'_'+region_name+'_'+timep+'_'+exp_name[e_p+1]+'.png'
