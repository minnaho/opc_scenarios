...
savename = 'massb_avg_'+varn+dep+'_'+region_name+'_'+timep+'_'+sce+'98.png'
...
savename = 'massb_avg_'+varn+dep+'_'+region_name+'_'+timep+'_'+sce+'99.png'
fig.savefig(savepath+savename,bbox_inches='tight')
...
savename = 'massb_avg_'+varn+dep+'_'+region_name+'_'+timep+'_'+sce+'16.png'
fig.savefig(savepath+savename,bbox_inches='tight')
...
savename = 'massb_avg_'+varn+dep+'_'+region_name+'_'+timep+'_'+sce+'17.png'
fig.savefig(savepath+savename,bbox_inches='tight')
