...
# control scenario
cntrl_nc = outpath+filename+'_'+depth+'_l1617_'+var_nc+'_avg_'+timename+'.nc'
...
if perc == True:
    savename = 'map_'+var_nc+'_'+depth+'_'+timename+'_'+region_name+'_'+exp[-1]+'_l1617_perc.png'
else:
    savename = 'map_'+var_nc+'_'+depth+'_'+timename+'_'+region_name+'_'+exp[-1]+'_l1617_abs.png'
