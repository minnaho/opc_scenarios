...
for t_i in range(len(ncfiles)):
    ...
    # plot maps
    p_plot_cntrl = ax.flat[t_i].pcolormesh(lon_nc,lat_nc,varplt,transform=ccrs.PlateCarree(),cmap=c_map,vmin=v_min,vmax=v_max)
    ...
    fig.suptitle(depth+'m '+var_nc+' '+timename,fontsize=axis_tick_size)
