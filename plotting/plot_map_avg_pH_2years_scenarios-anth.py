...
for e_i in range(2,len(exp)):
    ...
    print('area >'+str(clinemax2)+' change pH: '+str(int(pos_area))+' km^2')
    print('area <'+str(clinemin2)+' change pH: '+str(int(neg_area))+' km^2')
    ...
    #c_plot = ax.flat[e_i-2].contour(lon_nc,lat_nc,varplt,[clinemax],transform=ccrs.PlateCarree(),colors='blue',linestyles='dashed')
    c_plot = ax.flat[e_i-2].contour(lon_nc,lat_nc,varplt,[clinemax2],transform=ccrs.PlateCarree(),colors='red',linestyles='solid')
    #c_plot = ax.flat[e_i-2].contour(lon_nc,lat_nc,varplt,[clinemin],transform=ccrs.PlateCarree(),colors='red',linestyles='dashed')
