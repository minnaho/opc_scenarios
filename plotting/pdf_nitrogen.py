...
np.save(savepath+'n_p_count_'+varstr1+'_'+str(den)+'m_'+exp+'_all.npy',n_p1)
np.save(savepath+'flt_nonan_'+varstr1+'_'+str(den)+'m_'+exp+'_all.npy',flt1)
np.save(savepath+'bin_p_'+varstr1+'_'+str(den)+'m_'+exp+'_all.npy',bin_p1)

np.save(savepath+'n_p_count_'+varstr2+'_'+str(den)+'m_'+exp+'_all.npy',n_p2)
np.save(savepath+'flt_nonan_'+varstr2+'_'+str(den)+'m_'+exp+'_all.npy',flt2)
np.save(savepath+'bin_p_'+varstr2+'_'+str(den)+'m_'+exp+'_all.npy',bin_p2)
