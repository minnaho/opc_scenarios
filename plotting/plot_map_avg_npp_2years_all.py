...
for e_i in range(len(exp)):
    ...
    p_plot = ax.flat[e_i].pcolormesh(lon_nc,lat_nc,varplt,transform=ccrs.PlateCarree(),cmap=c_map,norm=mcolors.DivergingNorm(vmin=0,vcenter=75,vmax=v_max))
...
savename = 'map_2years_100m_int_'+varstr+'_'+region_name+'_'+exp[-1]+'_abs_spring.png'
