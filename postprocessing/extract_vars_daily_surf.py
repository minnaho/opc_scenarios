...
# path with outputs
#daily_path    = '/data/project6/minnaho/pipes_2013_2015/cntrl_daily/'
#exp = 'cntrl'
#daily_path    = '/data/project6/ROMS/L2SCB_P/daily/'
#exp = 'pipes'
daily_path    = '/data/project6/minnaho/pipes_2013_2015/fulll_daily/'
exp = 'fulll'
...
clim_path    = '/data/project6/minnaho/pipes_2013_2015/surf_sli/'
